...
madlib = f" Hallo! mein Name ist {name}.Ich bin {groesse}m groß und komme aus {stadt}. Mein Traum ist es einmal nach\
 {traum} zu reisen und dort {sportart}zu spielen. Am liebsten schaue ich {serie} und esse dabei {essen}.\
